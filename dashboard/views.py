...
def Food_category(request):
    ...
    #xrich_choice_df= cls.list_x_rich(df_frida, xrich_choice)
    
    return render(request, 'dashboard/alldashboards.html', {'choices_dict':choices_dict, "category":category, "df_category":df_frida_category, "name_list":name_list, "food_group_list":food_group_list, "barplot_foodwate":barplot_foodwate, "loop_range":loop_range})
...
def item_todisplay(request):
    ...
    return render(request, 'dashboard/alldashboards.html', {'choices_dict':choices_dict, "food_name_list":food_name_list, "food_group_list":food_group_list, "df_group_name_dict":df_group_name_dict,"loop_range":loop_range, "barplot_foodwate":barplot_foodwate, "group_plot_climate":group_plot_climate})
    


def category_list(request):
    xrich_choice= request.POST['x_riches']
    ...
    return render(request, 'dashboard/alldashboards.html', {'choices_dict':choices_dict, 'xrich_choice_df':xrich_choice_df, "food_name_list":food_name_list, "food_group_list":food_group_list, "df_group_name_dict":df_group_name_dict,"loop_range":loop_range, "barplot_foodwate":barplot_foodwate, "group_plot_climate":group_plot_climate})
