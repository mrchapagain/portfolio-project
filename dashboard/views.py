...
def foodname_todf(request):
    ...
    if foodname in flavour_data.index:
        ...
        flavour_img= cls.flavour_compound(foodname, fdf.food_flavour[0], fdf.flavour_1[0], fdf.flavour_2[0], fdf.flavour_3[0], fdf.flavour_4[0], fdf.flavour_5[0], 
                                        fdf.flavour_6[0], fdf.flavour_7[0], fdf.flavour_8[0], fdf.flavour_9[0], fdf.item_pair1[0], fdf.item_pair2[0], fdf.item_pair3[0], 
                                        fdf.item_pair4[0], fdf.item_pair5[0], fdf.item_pair6[0], fdf.item_pair7[0], fdf.item_pair8[0], fdf.item_pair9[0])
    else:
