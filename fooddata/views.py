...
def keyword_tosearch(request):
    ...
    pn_dict = {"denmark": "DK", "sweden": "SE", "germany": "DE", "united_states": "US", "united_kingdom": "UK", "india": "IN", "france":"FR", "netherlands":"NL"} #Country_Name.objects.all()
...
def timeframe_tosearch(request):
    ...
    pn_dict = {"denmark": "DK", "sweden": "SE", "germany": "DE", "united_states": "US", "united_kingdom": "UK", "india": "IN", "france":"FR"} #Country_Name.objects.all()
    st_dict = {"Default":"", "Image": "image", "News": "news"}
    cat_dict = { "All":0, "Health": 45, "Food_Drink": 71}
