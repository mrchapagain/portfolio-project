...
def itm_tosearch(request):
    ...
    climate_data="https://github.com/mrchapagain/FoodClimateAnalytics/raw/main/ClimateData.xlsx" # glob.glob(path + '*.xlsx')
    ...
    return render(request, 'fooddata/allfooddatas.html', {'food_pair':food_pair, 'name_choosen':name_choosen, 'co2_foodplots_item':co2_foodplots_item, 'energy_foodplots_item':energy_foodplots_item, 'choosen_item_data':choosen_item_data, 'top10_fooddatas':top10_fooddatas})
...
def cat_tosearch(request):
    ...
    #data_objects = Climatedf.objects
    ...
    massages={'Meat/poultry':"", 'Seafood':"", 'Oils/fats edible':"", 'Candy/sugar products':"", 'Prepared/preserved foods':"", 'Seasonings/preservatives/extracts':"", 'Milk/eggs/substitute products':"", 'Beverages':"", 'Bread/bakery products':"", 'Fruit/vegetable products':"", 'Cereal/grain/pulse products':"", 'Fruits':"", 'Vegetables':""}
    massage= map(lambda massage: massage if massage == category_choosen else "Massagenotfound", massages.items())

    return render(request, 'fooddata/allfooddatas.html', {'food_cat_list':food_cat_list, 'category_choosen':category_choosen, 'co2_category_piechart':co2_category_piechart, 'massage':massage, 'top10_fooddatas':top10_fooddatas})
